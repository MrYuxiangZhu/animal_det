...
bash run_train_detection.sh yolov5 configs/default.yaml
bash run_train_detection.sh mmdetection configs/default.yaml
bash run_train_detection.sh detectron2 configs/default.yaml
```

推理检测模型：

```bash
bash run_infer_detection.sh tiny_detector configs/default.yaml input.mp4 outputs/inference/tiny.mp4
bash run_infer_detection.sh grounding_dino configs/default.yaml input.mp4 outputs/inference/grounding.mp4 "cat,dog,fox"
bash run_infer_detection.sh yolov5 configs/default.yaml input.mp4 outputs/inference/yolov5.mp4
```
...
```bash
bash run_infer_recognition.sh timm configs/default.yaml animal_crop.jpg outputs/inference/timm.txt
bash run_infer_recognition.sh clip configs/default.yaml animal_crop.jpg outputs/inference/clip.txt "cat,dog,horse,fox"
```
